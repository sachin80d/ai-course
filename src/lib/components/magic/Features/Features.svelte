<script lang="ts">
  ...
  <section id="features" class="min-h-[100vh]">
    <div class="container">
      <div class="mx-auto max-w-6xl">
        <div class="mx-auto my-8 grid h-full items-center gap-10 lg:grid-cols-2">
          <div
            class="order-1 hidden lg:order-none lg:flex min-w-[700px] {ltr
          ...
          <div class="w-[350px] min-w-[200px] overflow-hidden h-auto h-[450px] min-h-[450px] max-h-[450px] self-start m-0 mx-auto {ltr && 'lg:order-1'}">
          ...
          <ul
            ...
            class="bg-background relative flex h-full snap-x snap-mandatory flex-nowrap overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] lg:hidden [&::-webkit-scrollbar]:hidden"
          >
            {#each data as item, index}
              ...
              <li
                class="bg-background card_code relative mr-8 grid h-full max-w-full pl-2 shrink-0 items-start justify-center last:mr-0"
