<script>
    ...
    import { EqualIcon, LucideEqual } from "lucide-svelte";
    ...
    import { ChevronRightIcon, CheckIcon } from "lucide-svelte";
...
<div class="flex flex-col gap-4 text-center z-0">
    <BlurFade delay={0.25}>
      <h1
        class="font-extralight
  xl:text-[76px]      /* font-size: 89px at ≥1280px */
    ...
    <BlurFade delay={0.25 * 2} class="mt-5">
      <div class="flex flex-row items-center justify-center gap-8">
        <div class="flex flex-col items-center justify-center">
          ...
          <span class=" font-light text-xs mt-2">Over 1 Lakh Students Subscribed</span>
        </div>
