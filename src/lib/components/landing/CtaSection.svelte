<script lang="ts">
	import { BarChart, ChartCandlestick, ShieldCheck, CircleDollarSign, Landmark, ChevronRight, File, Globe, AlignHorizontalDistributeCenter, Rss, Shield } from 'lucide-svelte';
	import Marquee from '../magic/marquee/Marquee.svelte';
	import CtaCard from './CtaCard.svelte';
	import RainbowButton from '$lib/components/magic/RainbowButton/RainbowButton.svelte';
		...
		<div class="flex w-full flex-col items-center justify-center">
			<div class="relative flex w-full flex-col items-center justify-center overflow-hidden">
				...
				<div class="absolute z-10">
					...
					>
						<ShieldCheck class="mx-auto size-16 text-black dark:text-white lg:size-24" />
					</div>
					<div class="z-10 mt-4 flex flex-col items-center text-center text-primary">
						<h1 class="text-3xl font-bold lg:text-4xl">Secure & Reliable.</h1>
						<p class="mt-2 mb-2">Start your Trading Journey with us.</p>
						<RainbowButton onClick={triggerButtonClick}>
