...
<svelte:head>
	<title>Sign Up | NextQuant.AI</title>
	<meta name="description" content="Sign Up for NextQuant.AI" />
</svelte:head>
...
<div class="container flex h-screen w-screen flex-col items-center justify-center">
	...
	<div class="mx-auto flex w-full flex-col justify-center gap-6 sm:w-[350px]">
		<div class="flex flex-col gap-2 text-center">
			...
			<h1 class="text-2xl font-semibold tracking-tight">Welcome to NextQuant.AI</h1>
